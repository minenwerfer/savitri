...
exports.publicRoutes = [
    ...
    },
    {
        path: '/signin',
        name: 'signin',
        component: () => Promise.resolve().then(() => __importStar(require('components/views/sv-signin/sv-signin.vue'))),
...
exports.privateRoutes = [
    {
        path: '/dashboard',
        name: 'dashboard',
        component: () => Promise.resolve().then(() => __importStar(require('components/templates/sv-dashboard/sv-dashboard.vue'))),
        ...
        children: [
            {
                path: 'c/:module?',
                name: 'dashboard-crud',
                component: () => Promise.resolve().then(() => __importStar(require('components/views/sv-dashboard/sv-crud-view/sv-crud-view.vue'))),
                meta: { title: '%viewTitle%', hidden: true, }
            },
            {
                path: 'access-edit',
                name: 'dashboard-access-edit',
                component: () => Promise.resolve().then(() => __importStar(require('components/views/sv-dashboard/sv-access-profile/sv-access-profile-edit.vue'))),
                meta: { title: 'Editar preset de acesso', hidden: true }
            },
            {
                path: 'user-profile',
                name: 'dashboard-user-profile',
                component: () => Promise.resolve().then(() => __importStar(require('components/views/sv-dashboard/sv-user/sv-profile/sv-profile.vue'))),
                meta: { title: 'Meu perfil', hidden: true }
            },
            {
                path: 'user-changepass',
                name: 'dashboard-user-changepass',
                component: () => Promise.resolve().then(() => __importStar(require('components/views/sv-dashboard/sv-user/sv-password-change/sv-password-change.vue'))),
