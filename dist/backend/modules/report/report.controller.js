...
class ReportController extends controller_1.Mutable {
    ...
    constructor() {
        super(report_model_1.Report, index_json_1.default, {
    ...
    async insert(props, req, decodedToken) {
        ...
        props.what.filters = props.what.type !== 'everything'
            ? (props.what.filters || {})
            : {};
        const Controller = (0, controller_1.getController)(props.what.module);
        ...
        props.what.file = await file_model_1.File.create({
    ...
    async download(_id) {
        const file = report_model_1.Report.findOne({ _id }).lean();
        if (!file) {
