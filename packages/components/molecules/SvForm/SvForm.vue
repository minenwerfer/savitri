...
const SvSearch = defineAsyncComponent(() => import('components/molecules/SvSearch/SvSearch.vue'))
const SvFile = defineAsyncComponent(() => import('components/molecules/SvFile/SvFile.vue'))
