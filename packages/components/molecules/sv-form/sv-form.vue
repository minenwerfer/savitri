...
import { SvInput, SvCheckbox, SvSelect } from 'components'

const SvSearch = defineAsyncComponent(() => import('components/molecules/sv-search/sv-search.vue'))
const SvFile = defineAsyncComponent(() => import('components/molecules/sv-file/sv-file.vue'))
